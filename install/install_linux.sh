#!/bin/bash
# NimsForest Package Manager Installation Script for Linux
# Usage: curl -fsSL get.nimsforest.com/linux | sh
...
install_binary() {
    ...
    local download_url="https://github.com/${GITHUB_REPO}/releases/download/${version}/${BINARY_NAME}_${os}_${arch}"
...
main() {
    log "Installing NimsForest Package Manager..."
